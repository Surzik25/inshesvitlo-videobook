...
document.addEventListener('click', e => {
  ...
  const bubbleMessages = {
            ...
            4: '✂ Тут є пару прикольних нарізок із самої книжки.<br><br><a href="https://youtube.com/watch?v=test123" target="_blank" style="color: #470616; text-decoration: underline;">🎥 Можете глянути ;3 →</a>',
			...
			7: '🖥️ Найкраще виглядає на великих моніторах (HD 1080px, 16:9). Поки що майже не адаптовано до мобільних пристроїв. Негайно чимчикуй до ПК, грр! 📺',
