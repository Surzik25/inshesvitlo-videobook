class TreasureBoxTimer {
    ...
    loadState() {
        const savedState = JSON.parse(localStorage.getItem('PerpereBoxStateN') || '{}');
    ...
    saveState() {
        ...
        localStorage.setItem('PerpereBoxStateN', JSON.stringify(state));
    }
...
setInterval(() => {
    ...
    restoreVisualState() {
        if (!this.isLocked) {
            this.boxImage.src = "../../images2/teapotIdleENG.gif";
