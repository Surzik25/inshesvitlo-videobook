  ...
  async function startLoading() {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // 🔔 Сигналізуємо іншим скриптам (наприклад, фоновій музиці), що
        // прелоадер повністю зник — і зберігаємо прапорець на випадок,
        // якщо слухач підпишеться вже ПІСЛЯ того, як подія прогриміла
